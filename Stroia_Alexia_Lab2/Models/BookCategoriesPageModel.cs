...
namespace Stroia_Alexia_Lab2.Models
{
    public class BookCategoriesPageModel: PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Stroia_Alexia_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Stroia_Alexia_Lab2Context context,
